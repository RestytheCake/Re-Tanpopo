...
class AnimeViewer:
    def __init__(self, master):
        ...
        self.current_anime_urls = sub.loadcovers.print_cover_images(watchtype="Currently Watching")
        self.rewatching_anime_urls = sub.loadcovers.print_cover_images(watchtype="Rewatching")
        self.completed_anime_urls = sub.loadcovers.print_cover_images(watchtype="Completed")
        self.plan_to_watch_anime_urls = sub.loadcovers.print_cover_images(watchtype="Plan to Watch")
        ...
        self.video_frame.rowconfigure(0, minsize=335)
        self.video_frame.rowconfigure(1, minsize=335)
